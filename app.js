...
//Function to diplay all menu contents on DOM load
...
//Function that handles selection of menu categories
function displayBtns(menu) {
  ...
  btns.forEach((btn) => {
    btn.addEventListener("click", () => {
      ...
      let choiceItems = menu.filter(function (choiceItem) {
        if (choiceItem.category === choice) {
          return choiceItem;
        }
      });
      ...
      if (choice === "all") {
        ...
        return displayItems(choiceItems);
      }
    });
  });
}
